...
namespace FickleFrostbite.FIT
{
   ...
   public class SegmentLapMesg : Mesg
   {
      ...
      {
         return Encoding.UTF8.GetString((byte[])GetFieldValue(29, 0, Fit.SubfieldIndexMainField));
      }
      ...
      {
         SetFieldValue(29, 0, System.Text.Encoding.UTF8.GetBytes(name_), Fit.SubfieldIndexMainField);
      }
      ...
      {
         return Encoding.UTF8.GetString((byte[])GetFieldValue(65, 0, Fit.SubfieldIndexMainField));
      }
      ...
      {
         SetFieldValue(65, 0, System.Text.Encoding.UTF8.GetBytes(uuid_), Fit.SubfieldIndexMainField);
      }
