...
namespace FickleFrostbite.FIT
{
   ...
   public class DateTime
   {
      ...
      {
         this.timeStamp = timeStamp + (uint) System.Math.Floor(fractionalTimeStamp);
         this.fractionalTimeStamp = fractionalTimeStamp - (double) System.Math.Floor(fractionalTimeStamp);
      }
