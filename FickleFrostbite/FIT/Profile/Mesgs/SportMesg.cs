...
namespace FickleFrostbite.FIT
{
   ...
   public class SportMesg : Mesg
   {
      ...
      #region Constructors
      public SportMesg() : base(Profile.mesgs[Profile.SportIndex])
      {
      }
      ...
      {
         return Encoding.UTF8.GetString((byte[])GetFieldValue(3, 0, Fit.SubfieldIndexMainField));
      }
      ...
      {
         SetFieldValue(3, 0, System.Text.Encoding.UTF8.GetBytes(name_), Fit.SubfieldIndexMainField);
      }
