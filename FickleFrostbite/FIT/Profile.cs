...
namespace FickleFrostbite.FIT
{
   ...
   public static class Profile
   {
      ...
      {                                                             
         ...
         fieldIndex++;
         fileIdMesg.SetField(new Field("ProductName", 8, 7, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         timestampCorrelationMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         timestampCorrelationMesg.SetField(new Field("FractionalTimestamp", 0, 132, 32768f, 0f, "s"));
         fieldIndex++;
         timestampCorrelationMesg.SetField(new Field("SystemTimestamp", 1, 134, 1f, 0f, "s"));
         fieldIndex++;
         timestampCorrelationMesg.SetField(new Field("FractionalSystemTimestamp", 2, 132, 32768f, 0f, "s"));
         fieldIndex++;
         timestampCorrelationMesg.SetField(new Field("LocalTimestamp", 3, 134, 1f, 0f, "s"));
         fieldIndex++;
         timestampCorrelationMesg.SetField(new Field("TimestampMs", 4, 132, 1f, 0f, "ms"));
         fieldIndex++;
         timestampCorrelationMesg.SetField(new Field("SystemTimestampMs", 5, 132, 1f, 0f, "ms"));
         fieldIndex++;         
         ...
         fieldIndex++;
         deviceInfoMesg.SetField(new Field("ProductName", 27, 7, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         cameraEventMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         cameraEventMesg.SetField(new Field("TimestampMs", 0, 132, 1f, 0f, "ms"));
         fieldIndex++;
         cameraEventMesg.SetField(new Field("CameraEventType", 1, 0, 1f, 0f, ""));
         fieldIndex++;
         cameraEventMesg.SetField(new Field("CameraFileUuid", 2, 7, 1f, 0f, ""));
         fieldIndex++;
         cameraEventMesg.SetField(new Field("CameraOrientation", 3, 0, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         gyroscopeDataMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("TimestampMs", 0, 132, 1f, 0f, "ms"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("SampleTimeOffset", 1, 132, 1f, 0f, "ms"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("GyroX", 2, 132, 1f, 0f, "counts"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("GyroY", 3, 132, 1f, 0f, "counts"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("GyroZ", 4, 132, 1f, 0f, "counts"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("CalibratedGyroX", 5, 136, 1f, 0f, "deg/s"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("CalibratedGyroY", 6, 136, 1f, 0f, "deg/s"));
         fieldIndex++;
         gyroscopeDataMesg.SetField(new Field("CalibratedGyroZ", 7, 136, 1f, 0f, "deg/s"));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         accelerometerDataMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("TimestampMs", 0, 132, 1f, 0f, "ms"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("SampleTimeOffset", 1, 132, 1f, 0f, "ms"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("AccelX", 2, 132, 1f, 0f, "counts"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("AccelY", 3, 132, 1f, 0f, "counts"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("AccelZ", 4, 132, 1f, 0f, "counts"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("CalibratedAccelX", 5, 136, 1f, 0f, "g"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("CalibratedAccelY", 6, 136, 1f, 0f, "g"));
         fieldIndex++;
         accelerometerDataMesg.SetField(new Field("CalibratedAccelZ", 7, 136, 1f, 0f, "g"));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         threeDSensorCalibrationMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         threeDSensorCalibrationMesg.SetField(new Field("SensorType", 0, 0, 1f, 0f, ""));
         fieldIndex++;
         threeDSensorCalibrationMesg.SetField(new Field("CalibrationFactor", 1, 134, 1f, 0f, ""));         
         subfieldIndex = 0;
         threeDSensorCalibrationMesg.fields[fieldIndex].subfields.Add(new Subfield("AccelCalFactor", 134, 1f, 0f, "g"));
         threeDSensorCalibrationMesg.fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 0);
         subfieldIndex++;
         threeDSensorCalibrationMesg.fields[fieldIndex].subfields.Add(new Subfield("GyroCalFactor", 134, 1f, 0f, "deg/s"));
         threeDSensorCalibrationMesg.fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 1);
         subfieldIndex++;
         fieldIndex++;
         threeDSensorCalibrationMesg.SetField(new Field("CalibrationDivisor", 2, 134, 1f, 0f, "counts"));
         fieldIndex++;
         threeDSensorCalibrationMesg.SetField(new Field("LevelShift", 3, 134, 1f, 0f, ""));
         fieldIndex++;
         threeDSensorCalibrationMesg.SetField(new Field("OffsetCal", 4, 133, 1f, 0f, ""));
         fieldIndex++;
         threeDSensorCalibrationMesg.SetField(new Field("OrientationMatrix", 5, 133, 65535f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         videoFrameMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         videoFrameMesg.SetField(new Field("TimestampMs", 0, 132, 1f, 0f, "ms"));
         fieldIndex++;
         videoFrameMesg.SetField(new Field("FrameNumber", 1, 134, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         obdiiDataMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("TimestampMs", 0, 132, 1f, 0f, "ms"));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("TimeOffset", 1, 132, 1f, 0f, "ms"));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("Pid", 2, 13, 1f, 0f, ""));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("RawData", 3, 13, 1f, 0f, ""));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("PidDataSize", 4, 2, 1f, 0f, ""));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("SystemTime", 5, 134, 1f, 0f, ""));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("StartTimestamp", 6, 134, 1f, 0f, ""));
         fieldIndex++;
         obdiiDataMesg.SetField(new Field("StartTimestampMs", 7, 132, 1f, 0f, "ms"));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         nmeaSentenceMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         nmeaSentenceMesg.SetField(new Field("TimestampMs", 0, 132, 1f, 0f, "ms"));
         fieldIndex++;
         nmeaSentenceMesg.SetField(new Field("Sentence", 1, 7, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         aviationAttitudeMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, "s"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("TimestampMs", 0, 132, 1f, 0f, "ms"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("SystemTime", 1, 134, 1f, 0f, "ms"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("Pitch", 2, 131, 10430.38f, 0f, "radians"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("Roll", 3, 131, 10430.38f, 0f, "radians"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("AccelLateral", 4, 131, 100f, 0f, "m/s^2"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("AccelNormal", 5, 131, 100f, 0f, "m/s^2"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("TurnRate", 6, 131, 1024f, 0f, "radians/second"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("Stage", 7, 0, 1f, 0f, ""));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("AttitudeStageComplete", 8, 2, 1f, 0f, "%"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("Track", 9, 132, 10430.38f, 0f, "radians"));
         fieldIndex++;
         aviationAttitudeMesg.SetField(new Field("Validity", 10, 132, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         videoMesg.SetField(new Field("Url", 0, 7, 1f, 0f, ""));
         fieldIndex++;
         videoMesg.SetField(new Field("HostingProvider", 1, 7, 1f, 0f, ""));
         fieldIndex++;
         videoMesg.SetField(new Field("Duration", 2, 134, 1f, 0f, "ms"));
         fieldIndex++;         
         mesgs.Add(videoMesg);         
         ...
         fieldIndex = 0;
         videoTitleMesg.SetField(new Field("MessageIndex", 254, 132, 1f, 0f, ""));
         fieldIndex++;
         videoTitleMesg.SetField(new Field("MessageCount", 0, 132, 1f, 0f, ""));
         fieldIndex++;
         videoTitleMesg.SetField(new Field("Text", 1, 7, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         videoDescriptionMesg.SetField(new Field("MessageIndex", 254, 132, 1f, 0f, ""));
         fieldIndex++;
         videoDescriptionMesg.SetField(new Field("MessageCount", 0, 132, 1f, 0f, ""));
         fieldIndex++;
         videoDescriptionMesg.SetField(new Field("Text", 1, 7, 1f, 0f, ""));
         fieldIndex++;         
         ...
         fieldIndex = 0;
         videoClipMesg.SetField(new Field("ClipNumber", 0, 132, 1f, 0f, ""));
         fieldIndex++;
         videoClipMesg.SetField(new Field("StartTimestamp", 1, 134, 1f, 0f, ""));
         fieldIndex++;
         videoClipMesg.SetField(new Field("StartTimestampMs", 2, 132, 1f, 0f, ""));
         fieldIndex++;
         videoClipMesg.SetField(new Field("EndTimestamp", 3, 134, 1f, 0f, ""));
         fieldIndex++;
         videoClipMesg.SetField(new Field("EndTimestampMs", 4, 132, 1f, 0f, ""));
         fieldIndex++;
         videoClipMesg.SetField(new Field("ClipStart", 6, 134, 1f, 0f, "ms"));
         fieldIndex++;
         videoClipMesg.SetField(new Field("ClipEnd", 7, 134, 1f, 0f, "ms"));
         fieldIndex++;         
